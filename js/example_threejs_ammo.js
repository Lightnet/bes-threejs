...
var Example_threejs_ammo = (function (_Threejsbes) {
  ...
  function Example_threejs_ammo(settings) {
    ...
    _this.scriptlist.push('/js/libs/ammo.js');
    return _this;
  }
  ...
  _createClass(Example_threejs_ammo, [{
    ...
    key: 'createAmmoScene',
    value: function createAmmoScene() {
      ...
      if (isDynamic) groundShape2.calculateLocalInertia(mass, localInertia2);
    ...
    value: function updateAmmoPhysics() {
      _get(Example_threejs_ammo.prototype.__proto__ || Object.getPrototypeOf(Example_threejs_ammo.prototype), 'updateAmmoPhysics', this).call(this);
