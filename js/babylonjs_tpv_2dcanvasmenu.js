...
window.addEventListener('DOMContentLoaded', (function () {
    ...
    var createScene = function createScene() {
        ...
        { parent: screenCanvas, id: "button", x: 10, y: -10, width: 100, height: 100, fill: "#40C040FF",
            ...
            children: [new BABYLON.Text2D("List1!", { x: 0, y: 10, fontName: "10pt Arial", marginAlignment: "h: center, v: center" })]
        });
        //center screen
        //var buttonRect = new BABYLON.Rectangle2D(
        //{ parent: screenCanvas, id: "button", x: 10, y: 10, width: 100, height: 100, fill: "#40C040FF",
        ...
        var buttonRect = new BABYLON.Rectangle2D(
            { parent: group2d, id: "button", x: 10, y: 100, width: 200, height: 80, fill: "#40C040FF",
                ...
                */
        function createbutton(_parent, _text, _x, _y, _callback) {
            var _text = new BABYLON.Text2D(_text, { fontName: "30pt Arial", marginAlignment: "h: center, v: center" });
            var buttonRect = new BABYLON.Rectangle2D({ parent: _parent, id: "button", x: _x, y: _y, width: 256, height: 80, fill: "#40C040FF",
                //roundRadius: 10,
                children: [_text] });
        ...
        //quit
        /*
        createbutton(group2d,"Quit",10,100,()=>{
            console.log("click event!");
        });
          createbutton(group2d,"About",10,200,()=>{
            console.log("click event!");
        });
          createbutton(group2d,"Credits",10,300,()=>{
            console.log("click event!");
        });
          createbutton(group2d,"Options",10,400,()=>{
            console.log("click event!");
        });
          createbutton(group2d,"Editor",10,500,()=>{
            console.log("click event!");
        });
          createbutton(group2d,"New Game",10,600,()=>{
            console.log("click event!");
        });
          createbutton(group2d,"Load Game",10,700,()=>{
            console.log("click event!");
        });
          createbutton(group2d,"Continue",10,800,()=>{
            console.log("click event!");
        });
        */
