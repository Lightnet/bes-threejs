...
window.addEventListener('DOMContentLoaded', (function () {
    ...
    var createScene = function createScene() {
        ...
        var group2d_01 = new BABYLON.Group2D((_ref = {
            parent: screenCanvas,
            id: "group2d_01"
        }, _defineProperty(_ref, 'id', "GroupTag #" + 0), _defineProperty(_ref, 'width', 80), _defineProperty(_ref, 'height', 40), _defineProperty(_ref, 'trackNode', EmptyPivot), _defineProperty(_ref, 'children', [new BABYLON.Rectangle2D({ id: "firstRect", width: 80, height: 26, x: 0, y: 0, origin: BABYLON.Vector2.Zero(), border: "#FFFFFFFF", fill: "#808080FF", children: [new BABYLON.Text2D(box1.name, { marginAlignment: "h: center, v:center", fontName: "bold 12px Arial" })]
        })]), _ref));

        var buttonRect = new BABYLON.Rectangle2D({ parent: screenCanvas, id: "button", x: 10, y: 100, width: 200, height: 80, fill: "#40C040FF",
            //roundRadius: 10,
            children: [new BABYLON.Text2D("Drag Me!", { fontName: "30pt Arial", marginAlignment: "h: center, v: center" })] });

        //http://doc.babylonjs.com/overviews/Canvas2D_Interaction
        //var cb = function (ppi, es) {
        //console.log("Target: " + ppi.relatedTarget.id + ", Event State: " + es.mask);
        //};
        //buttonRect.pointerEventObservable.add(cb);


        console.log(buttonRect);

        //console.log(BABYLON.PrimitivePointerInfo);

        buttonRect.bdrag = false;
        var dragpostion = new BABYLON.Vector2(0, 0);
        buttonRect.pointerEventObservable.add((function (d, s) {
            //button2Rect.levelVisible = !button2Rect.levelVisible;
            console.log("PointerDown!");
            //console.log(d);
            //console.log(buttonRect);
            buttonRect.bdrag = true;
            dragpostion = d.primitivePointerPos;
        ...
        buttonRect.pointerEventObservable.add((function (d, s) {
            if (buttonRect.bdrag) {
                buttonRect.x = d.canvasPointerPos.x - dragpostion.x;
                buttonRect.y = d.canvasPointerPos.y - dragpostion.y;
            }
        ...
        buttonRect.pointerEventObservable.add((function (d, s) {
            console.log("PointerGotCapture!");
        }), BABYLON.PrimitivePointerInfo.PointerGotCapture);

        buttonRect.pointerEventObservable.add((function (d, s) {
            console.log("PointerMouseWheel!");
        }), BABYLON.PrimitivePointerInfo.PointerMouseWheel);

        buttonRect.actionManager.registerAction(new BABYLON.SetValueAction(BABYLON.ActionManager.OnPointerOutTrigger, buttonRect, "bdrag", false));
