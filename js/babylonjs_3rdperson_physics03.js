...
window.addEventListener('DOMContentLoaded', (function () {
    ...
    var createScene = function createScene() {
        ...
        var point = BABYLON.MeshBuilder.CreateCylinder("indicator", { height: 1, diameterTop: 0, diameterBottom: 0.5 }, scene);
        ...
        var ray = new BABYLON.Ray(new BABYLON.Vector3(0, 0, 0), new BABYLON.Vector3(0, 0, 10), 5);
        console.log(ray);

        var hit = BABYLON.Mesh.CreateBox("hit", 0.5, scene);
        ...
        model.update = function () {
            ...
            //this breaks
            var forward = camera.getFrontPosition(10).subtract(camera.position).normalize(); //does not work bug //works in 2.5
            var needMove = false;
            forward.y = 0;
            //get rotation dir
            ...
            if (leftstickmove) {
                ...
                point.rotation.y = diffAngle + joyangle + Math.PI;
            ...
            if (leftstickmove) fdir = BABYLON.Vector3.TransformCoordinates(new BABYLON.Vector3(0, 0, 1), BABYLON.Matrix.RotationY(rot));
            if (needMove) {
                fdir = BABYLON.Vector3.TransformCoordinates(new BABYLON.Vector3(0, 0, -1), BABYLON.Matrix.RotationY(currentAngle));
            }
            var rayPick = new BABYLON.Ray(point.position, fdir);
