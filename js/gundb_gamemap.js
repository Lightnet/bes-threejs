...
function AddMapKey() {
    gun.get('map/key').set({ name: "random", id: "01" }, (function (error, ok) {
        if (error) {
            console.log(error);
        }
        console.log(ok);
...
function GameMapList() {
    gun.get('map/key').val((function (value, property) {
        console.log("....");
        console.log(value);
...
function GameMapListStream() {
    gun.get('map/key').each((function (message, id) {
        console.log(id, message);
    }));
}
...
function AddGameMap() {
    ...
    gamemap.put({ name: "test", id: "000" }, (function (error, ok) {
        if (error) {
            console.log(error);
            return;
        }
