...
window.addEventListener('DOMContentLoaded', function() {
    ...
    var createScene = function(){
        ...
        var buttonRect = new BABYLON.Rectangle2D(
            { parent: screenCanvas, id: "button", x: 10, y: 100, width: 200, height: 80, fill: "#40C040FF",
                //roundRadius: 10,
                children:
                [
                    new BABYLON.Text2D("Drag Me!", { fontName: "30pt Arial", marginAlignment: "h: center, v: center" })
                ]});
