define(['exports', './ObjectRPGID'], function (exports, _ObjectRPGID2) {
    ...
    var RPGMaterial = exports.RPGMaterial = function (_ObjectRPGID) {
        ...
        function RPGMaterial(args) {
            ...
            var _this = _possibleConstructorReturn(this, (RPGMaterial.__proto__ || Object.getPrototypeOf(RPGMaterial)).call(this, args));

            _this.objtype = "material";
            _this.nameClass = "RPGMaterial";
            return _this;
        }
