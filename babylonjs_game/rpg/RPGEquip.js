define(['exports', './ObjectRPGID'], function (exports, _ObjectRPGID2) {
    ...
    var RPGEquip = exports.RPGEquip = function (_ObjectRPGID) {
        ...
        function RPGEquip(args) {
            ...
            var _this = _possibleConstructorReturn(this, (RPGEquip.__proto__ || Object.getPrototypeOf(RPGEquip)).call(this, args));

            _this.objtype = "equip";
            _this.nameClass = "RPGEquip";
            return _this;
        }
